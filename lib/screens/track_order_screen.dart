...
class _TrackOrderScreenState extends State<TrackOrderScreen> {
  ...
  void initState() {
    ...
    // User Location (from OrderModel)
    userLocation = LatLng(
      double.tryParse(widget.order.latitude ?? '') ?? 11.5564,
      double.tryParse(widget.order.longitude ?? '') ?? 104.9282,
    );

    // Store Location (from first product's store address)
...
//     setState(() {
//       userLocation = LatLng(lat ?? 11.5564, lon ?? 104.9282);
//     });

//     _createMarkers();

//     // Load route only after user location is loaded
...
//     LatLngBounds bounds = LatLngBounds(
//       southwest: LatLng(
//         min(userLocation!.latitude, storeLocation.latitude),
//         min(userLocation!.longitude, storeLocation.longitude),
//       ),
//       northeast: LatLng(
//         max(userLocation!.latitude, storeLocation.latitude),
//         max(userLocation!.longitude, storeLocation.longitude),
//       ),
//     );
